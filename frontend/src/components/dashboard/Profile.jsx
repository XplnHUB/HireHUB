...
const Profile = () => {
    ...
    const fetchProfile = async () => {
        try {
            ...
            // Merge with existing state to ensure all fields exist
            setProfileData(prev => ({
                ...prev,
                ...response.data,
                // Ensure nested objects don't override
            ...
            // If 404, it means profile doesn't exist yet, which is fine for new users
    ...
    // Helper to manage array fields (education, experience, etc.)
    // For simplicity in this snippet, we'll focus on the main structure.
    // In a full implementation, we'd add handlers for adding/removing items from arrays.
